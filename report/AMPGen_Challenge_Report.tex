...
\includegraphics[width=0.72\textwidth]{figures/pipeline.pdf}
...
\begin{tabular}{@{}p{2.1cm}p{6.6cm}rrp{2.3cm}@{}}
\toprule
...
$\log_{10}$ \uM; free-termini flags \\
HC50 (human RBC) & ampbench master \texttt{hc50\_human} (DBAASP, HemoPI2, Hemolytik, QMAP,
DRAMP) $+$ Hemolytik2 $+$ DRAMP text & 4{,}402 & 4{,}402 & 14.2\% right-censored \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}p{5.6cm}rrp{4.2cm}@{}}
\toprule
...
Wasserstein (len, charge, GRAVY, $\mu$H, hydrophob.) & --- & \multicolumn{2}{p{5.2cm}}{0.000 / 0.099 / 0.014 / 0.005 / 0.002 (lower $=$ closer)} \\
\bottomrule
\end{tabular}
\end{table}
