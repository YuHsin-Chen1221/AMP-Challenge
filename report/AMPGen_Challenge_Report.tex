...
\caption{\textbf{Version progression v2 $\to$ v3 $\to$ v4, category-level \emph{honest} ranking.} Bars
...
$\rho$ shown per split in Figure~1 (deployed v2 model) and used for the fair data ablation in
