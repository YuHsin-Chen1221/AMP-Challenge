...
split} (Table~6): same held-out test, training data $\pm$AMPBench-MT. There the merge
...
\begin{table}[h]\centering\small
\caption{MIC Spearman $\rho$ per panel species for the recommended v2 model on \emph{both} splits
(homology = honest, random = leaky reference), with each split's test size. Low-$n$ species carry
wide confidence intervals; the homology/random gap is the honest penalty.}
\begin{tabular}{@{}lrrrr@{}}
\toprule
\textbf{Species} & \textbf{$\rho$ (hom)} & \textbf{$n$ (hom)} & \textbf{$\rho$ (rand)} & \textbf{$n$ (rand)} \\
\midrule
\spn{E. coli}       & 0.598 & 937 & 0.653 & 865 \\
\spn{S. aureus}     & 0.550 & 774 & 0.606 & 721 \\
\spn{P. aeruginosa} & 0.631 & 620 & 0.655 & 507 \\
\spn{B. subtilis}   & 0.546 & 90  & 0.591 & 90  \\
\spn{S. enterica}   & 0.578 & 48  & 0.675 & 68  \\
\spn{K. pneumoniae} & 0.590 & 47  & 0.655 & 49  \\
\spn{E. faecalis}   & 0.255 & 39  & 0.504 & 45  \\
\spn{E. cloacae}    & 0.356 & 25  & 0.463 & 22  \\
\spn{E. faecium}    & 0.469 & 19  & 0.460 & 23  \\
\spn{A. baumannii}  & 0.681 & 13  & 0.612 & 21  \\
\bottomrule
\end{tabular}
\end{table}
...
($\rho$ $+0.047$); (ii) the controlled data ablation (Table~6) shows AMPBench-MT genuinely improves
